...
// import AI_Assistant_Image from "../assets/AI_Assisant.png"; // <-- Loại bỏ import ảnh tĩnh
...
const HeroAIAssistant = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20"> {/* Tăng z-index */}
        <div className="flex flex-col md:flex-row gap-16 lg:gap-24 items-center justify-between">
          ...
          <div className="w-full md:w-1/2 space-y-6 text-center md:text-left">
            ...
            >
              ...
              >
                AI đồng hành, <span style={{ color: COLORS.surface }}>hiệu suất vượt trội</span>
              </h2>
              <p
              ...
              >
                UniPlan AI không chỉ là công cụ, mà là trợ lý cá nhân giúp bạn tối ưu mọi quy trình, từ ý tưởng đến hoàn thiện.
              </p>
            </motion.div>
            ...
            <div className="flex flex-col gap-6 pt-6 text-left mx-auto md:mx-0 max-w-md md:max-w-none">
              {features.map((feature, index) => (
                ...
                >
                  <div className="mt-1 flex-shrink-0" style={{ color: COLORS.primary }}>{feature.icon}</div> {/* Icon màu primary */}
                  <div>
