...
import {
  Users, Settings, FolderOpen, Info, Crown, Shield, Calendar, TrendingUp, Edit3
} from "lucide-react";
...
export default function TeamDetailPage() {
  ...
  const loading = teamLoading || membersLoading || projectsLoading;
  const overallError = teamError || membersError || projectsError;
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
              ...
              <div className="p-6">
                <Routes>
                  ...
                  <Route path="info" element={<TeamInfoTab team={teamDisplayData} membersCount={memberCount} projectsCount={projectCount} />} />
...
const TeamInfoTab: React.FC<TeamInfoTabProps> = ({ team, membersCount, projectsCount }) => {
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* Statistics */}
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Thống kê</h3>
